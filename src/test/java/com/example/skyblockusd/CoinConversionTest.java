...
class CoinConversionTest {
    @Test void usesElevenThousandGemBundleWithoutIntermediateRounding() {
        ...
        assertEquals("1.000 cookies | $2.95 USD", value.display());
    }
    ...
    @Test void formattingDoesNotDependOnThePlayersLocale() {
        ...
        try { Locale.setDefault(Locale.GERMANY); assertEquals("1.000 cookies | $2.95 USD", CoinConversion.of(10, 10).display()); }
