...
public class CoinsToMoneyConfigScreen extends Screen {
    ...
    @Override protected void init() {
        ...
        button("Currency: " + c.currencyCode, "Choose a real-world currency and enter target-currency units per 1 USD. This is a saved manual rate, not a live FX quote. Cookie prices still update automatically.", () -> minecraft.gui.setScreen(new CurrencyConfigScreen(this)), right, top + 66, w);
    ...
    @Override public void onClose() { ModConfig.save(); if (minecraft != null) minecraft.gui.setScreen(parent); }
